...
run unit_op_create_fires { some ii: InventoryItem, q: Quantity | create[ii, q, none] } for 6 but 3 Scalar
...
run unit_rej_replenish_locked { some ii: InventoryItem, q: Quantity | replenish[ii, q, none, none] and ii.administrativeState = LOCKED } for 6 but 3 Scalar
run unit_rej_lock_alreadyLocked { some ii: InventoryItem | lock[ii] and ii.administrativeState = LOCKED } for 6 but 3 Scalar
run unit_rej_create_reuseRetired { some ii: InventoryItem, q: Quantity | create[ii, q, none] and ii in Retired } for 6 but 3 Scalar
