 ...
 * facts. Scope notes: the reified machines demand the exact FSM pins (as in the structural
 * suite); `5 Int` is REQUIRED — the region ranks reach 8, which overflows 4-bit Int.
 */

// Phase-A card-level readings (Phase B moves these into kanban_card.als).
...
} for 5 but 5 Int, 3 Scalar, 4 Quantity, 14 State, 20 Signal, 20 Transition, 2 StateMachine, 0 Guard,
...
} for 6 but 5 Int, 3 Scalar, 4 Quantity, 14 State, 20 Signal, 20 Transition, 2 StateMachine, 0 Guard,
      2 CardCycle, 1 KanbanCard, 0 InventoryItem expect 1
...
check unit_cyc_oneLiveCyclePerCard for 5 but 5 Int, 3 Scalar, 4 Quantity, 14 State, 20 Signal, 20 Transition, 2 StateMachine, 0 Guard,
...
check unit_cyc_forwardMonotone for 5 but 5 Int, 3 Scalar, 4 Quantity, 14 State, 20 Signal, 20 Transition, 2 StateMachine, 0 Guard,
      3 CardCycle, 2 KanbanCard, 0 InventoryItem expect 0
...
check unit_cyc_emptyBeforeFulfilling for 5 but 5 Int, 3 Scalar, 4 Quantity, 14 State, 20 Signal, 20 Transition, 2 StateMachine, 0 Guard,
...
check unit_cyc_closureIsTerminal for 5 but 5 Int, 3 Scalar, 4 Quantity, 14 State, 20 Signal, 20 Transition, 2 StateMachine, 0 Guard,
      3 CardCycle, 2 KanbanCard, 0 InventoryItem expect 0
